...
# get a log file
my $log_fh=get_log_fh('compare_ind_genes_readcount.RNAseqComp.log',
		      $debug);
print $log_fh "Extracting readcount info for the following genes: ",
    join(",",@genes_needed),"\n";
...
my $tmpfn="Gene.Readcounts.subset.txt";
...
my $outfile='Gene.Readcounts.csv';
